...
use App\flightsearchpage;

use Illuminate\Http\Request;

class flightsearchpageController extends Controller
{
    /**
    ...
    {
        //
        $categ = flightsearchpage::where('status',1)->paginate(5);
        return view('pages.searchpage.flightsearchpage',compact('categ'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->file('search_image') != null) {
                ...
                $request->session()->flash('msg-success', 'Flight Banner Added successfully!');
                return redirect()->route('flightsearchpage.index');
    ...
    {
        //
         $cat = flightsearchpage::where('id',$id)->first();

        $categ = flightsearchpage::where('status',1)->paginate(5);

        return view('pages.searchpage.flightsearchpage',compact('cat','categ'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($id) {
            $category = flightsearchpage::where('id', $id)->first();
            ...
            if ($request->file('search_image') != null) {
                ...
                session()->flash('msg-success', 'Flight Banners Updated successfully!');
                return redirect()->route('flightsearchpage.index');
    ...
    public function destroy($id)
    {
       ...
       try {
            ...
            $category = flightsearchpage::where('id', $id)->first();
                ...
                session()->flash('msg-success', 'Flight banners has been Deleted!');
                return redirect()->route('flightsearchpage.index');
