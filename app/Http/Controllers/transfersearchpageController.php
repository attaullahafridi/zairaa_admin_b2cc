...
use App\transfersearchpage;

class transfersearchpageController extends Controller
{
    /**
    ...
    {
        //
         $categ = transfersearchpage::where('status',1)->paginate(5);
        return view('pages.searchpage.transfersearchpage',compact('categ'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if ($request->file('search_image') != null) {
                ...
                $request->session()->flash('msg-success', 'Transfer Banner Added successfully!');
                return redirect()->route('transfersearchpage.index');
    ...
    {
        //
        $cat = transfersearchpage::where('id',$id)->first();

        $categ = transfersearchpage::where('status',1)->paginate(5);

        return view('pages.searchpage.transfersearchpage',compact('cat','categ'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($id) {
            $category = transfersearchpage::where('id', $id)->first();
            ...
            if ($request->file('search_image') != null) {
                ...
                session()->flash('msg-success', 'Transfer Banners Updated successfully!');
                return redirect()->route('transfersearchpage.index');
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $category = transfersearchpage::where('id', $id)->first();
                ...
                session()->flash('msg-success', 'Transfer banners has been Deleted!');
                return redirect()->route('transfersearchpage.index');
