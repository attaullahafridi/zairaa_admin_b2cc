...
<div class="card">
	<div class="card-body">
		@if(isset($cat))
				{!! Form::model($cat,['route' => ['itnry.update', $cat->id ], 'method' => 'put', 'files' => true]) !!}
				@else
				{!! Form::open(['route' => ['itnry.store'], 'method' => 'post', 'files' => true]) !!}
				@endif

				@csrf
			<fieldset class="mb-3">
				<legend class="text-uppercase font-size-sm font-weight-bold">Package Itinerary</legend>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::textarea('heading', null,['id'=>'','class'=>'form-control summernote','required'=>'required']) !!}
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-lg-10">
							{!! Form::textarea('details', null,['id'=>'','class'=>'form-control summernote','required'=>'required']) !!}
						</div>
					</div>
			...
			<div class="text-right">
				<a href="{{route('itnry.index')}}" class="btn btn-danger text-white">Cancel</a>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="{{route('itnry.edit',$ca->id)}}"><i class="fa fa-edit fa-lg"></i></a>&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['itnry.destroy',$ca->id], 'method' => 'delete','id'=>'']) !!}
