...
<div class="card">
	...
	<div class="card-header header-elements-inline">
		<div class="container">
		<form method="get" action="{{route('activitydetail',[1])}}">
			<div class="row">
				<div class="col-md-1">
					<p>Date:</p>
				</div>
				...
				<div class="col-md-1">
					<a href="#" class="btn btn-danger" onclick="activitypdf()">Export PDF</a>
				</div>
			</div>
	</form>
		</div>
...
function activitypdf(){
	...
	window.location.href = "{{url('activitypdf')}}/"+date;
}
...
function dest(val){
	...
	// alert(date1);
	window.location.href = "{{url('activitylocation')}}/"+date1+"/"+val;
