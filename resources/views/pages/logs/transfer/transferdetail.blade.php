...
<div class="card">
	...
	<div class="card-header header-elements-inline">
		<div class="container">
		<form method="get" action="{{route('transferdetail',[1])}}">
			<div class="row">
				<div class="col-md-1">
					<p>Date:</p>
				</div>
				...
				<div class="col-md-1">
					<a href="#" class="btn btn-danger" onclick="transferpdf()">Export PDF</a>
				</div>
			</div>
	</form>
		</div>
...
function transferpdf(){
	...
	window.location.href = "{{url('transferpdf')}}/"+date;
}
...
function dest(val){
	...
	// alert(date1);
	window.location.href = "{{url('transferlocation')}}/"+date1+"/"+val;
