...
<div class="card">
	<div class="card-body">
		@if(isset($cat))
				{!! Form::model($cat,['route' => ['actsearchpage.update', $cat->id ], 'method' => 'put', 'files' => true]) !!}
				@else
				{!! Form::open(['route' => ['actsearchpage.store'], 'method' => 'post', 'files' => true]) !!}
				@endif

				@csrf
			<fieldset class="mb-3">
				<legend class="text-uppercase font-size-sm font-weight-bold">Activity Search Page</legend>
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<p style="color: red;">Image Size: 300x400</p>
						</div>
					...
					<div class="form-group row">
						<label class="col-form-label col-lg-2">Ad Banner 3</label>
						<div class="col-lg-2">

							{!! Form::file('ad_banner_3', null,['id'=>'','class'=>'form-control','required'=>'']) !!}
						...
						<div class="col-lg-3">
							<p style="color: red;">Image Size: 300x500</p>
						</div>
			...
			<div class="text-right">
				<a href="{{route('actsearchpage.index')}}" class="btn btn-danger text-white">Cancel</a>
...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="{{asset('public/images')}}/{{$ca->search_image}}" target="__blank"><img src="{{asset('public/images')}}/{{$ca->search_image}}" height="41" width="42"></a></td>
			...
			<td><a href="{{asset('public/images')}}/{{$ca->ad_banner_3}}" target="__blank"><img src="{{asset('public/images')}}/{{$ca->ad_banner_3}}" height="42" width="42"></a></td>




			<td class="text-center">
				<a href="{{route('actsearchpage.edit',$ca->id)}}"><i class="fa fa-edit fa-lg"></i></a>&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['actsearchpage.destroy',$ca->id], 'method' => 'delete','id'=>'']) !!}
