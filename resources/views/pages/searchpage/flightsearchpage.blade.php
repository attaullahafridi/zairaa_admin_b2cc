...
<div class="card">
	<div class="card-body">
		@if(isset($cat))
				{!! Form::model($cat,['route' => ['flightsearchpage.update', $cat->id ], 'method' => 'put', 'files' => true]) !!}
				@else
				{!! Form::open(['route' => ['flightsearchpage.store'], 'method' => 'post', 'files' => true]) !!}
				@endif

				@csrf
			<fieldset class="mb-3">
				<legend class="text-uppercase font-size-sm font-weight-bold">Flights Search Page</legend>
					...
					<div class="form-group row">
						...
						<div class="col-lg-3">
							<p style="color: red;">Image Size: 300x800</p>
						</div>
			...
			<div class="text-right">
				<a href="{{route('flightsearchpage.index')}}" class="btn btn-danger text-white">Cancel</a>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="{{route('flightsearchpage.edit',$ca->id)}}"><i class="fa fa-edit fa-lg"></i></a>&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['flightsearchpage.destroy',$ca->id], 'method' => 'delete','id'=>'']) !!}
