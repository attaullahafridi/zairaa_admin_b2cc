...
<div class="card">
	<div class="card-body">
		@if(isset($cat))
				{!! Form::model($cat,['route' => ['transfersearchpage.update', $cat->id ], 'method' => 'put', 'files' => true]) !!}
				@else
				{!! Form::open(['route' => ['transfersearchpage.store'], 'method' => 'post', 'files' => true]) !!}
				@endif

				@csrf
			<fieldset class="mb-3">
				<legend class="text-uppercase font-size-sm font-weight-bold">Transfer Search Page</legend>
			...
			<div class="text-right">
				<a href="{{route('transfersearchpage.index')}}" class="btn btn-danger text-white">Cancel</a>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="{{route('transfersearchpage.edit',$ca->id)}}"><i class="fa fa-edit fa-lg"></i></a>&nbsp;
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            {!! Form::open(['route' => ['transfersearchpage.destroy',$ca->id], 'method' => 'delete','id'=>'']) !!}
